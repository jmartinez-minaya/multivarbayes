...
- For a detailed tutorial on fitting a Bayesian multivariate linear regression model, check out the vignette: [Link to vignette](https://github.com/jmartinez-minaya/multivarbayes/blob/master/vignettes/multivarbayes-vignette.Rmd)
